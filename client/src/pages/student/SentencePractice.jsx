...
export default function SentencePractice() {
        ...
        <main className="mx-auto max-w-3xl">
          <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_14px_40px_rgba(15,23,42,0.08)]">
            ...
            <div className="p-6 sm:p-9">
              ...
              <section className="mt-8 rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-700 p-6 text-white shadow-xl sm:p-8">
                ...
                <p className="mt-3 font-semibold leading-7 text-indigo-50">
                  Watch the short video and learn how to use the sentences you
                  just practised.
                </p>
          ...
          <div className="overflow-hidden rounded-[28px] border border-slate-200/80 bg-white shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
            ...
            <div className="p-6 sm:p-9">
              ...
              <div className="mt-7 grid gap-3">
                ...
                <button
                  type="button"
                  className="w-full rounded-2xl border border-slate-300 bg-slate-100 px-6 py-5 text-lg font-black text-slate-800 shadow-sm transition hover:bg-slate-200"
                  onClick={() => {
                    track("practice_cta_clicked", {
                      lessonId: Number(lid) || 0,
                      difficulty,
                ...
                >
                  ← Back to Lesson {currentLessonNumber}
                </button>
                ...
                {nextLessonId ? (
                  <button
                    type="button"
                    className="w-full rounded-2xl border border-indigo-300 bg-indigo-100 px-6 py-5 text-lg font-black text-indigo-800 shadow-sm transition hover:bg-indigo-200"
                    onClick={() => {
                      track("practice_cta_clicked", {
                        lessonId: Number(lid) || 0,
                        difficulty,
                ...
                <button
                  type="button"
                  className="w-full rounded-2xl border border-amber-300 bg-amber-100 px-6 py-5 text-base font-black text-amber-800 shadow-sm transition hover:bg-amber-200"
  ...
  function AudioVariantToggle({ audioVariant, onGoVariant }) {
    return (
      <div className="inline-flex items-center rounded-2xl border border-slate-300 bg-indigo-100 p-1 shadow-inner">
        <button
          type="button"
    ...
    if (safeMode === "audio" && audioVariant === "repeat") {
      ...
      if (voiceStep === VOICE_STEPS.COMPARE) {
        return {
          ...
          secondary: [],
          hintText: "Step 4: Compare your voice with the model",
        };
      }
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-20">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 px-3 py-2.5 text-sm font-bold text-white hover:opacity-90 disabled:opacity-50"
                    disabled={!englishFull}
                  >
                    ▶ Listen
                  </button>
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex w-full items-center justify-center rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2.5 text-sm font-bold text-emerald-800 hover:bg-emerald-100 disabled:opacity-50"
                    disabled={
                ...
                >
                  ...
                  {!isRecording ? (
                    <button
                      ...
                      className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-3 py-2.5 text-sm font-bold text-white hover:bg-emerald-700 disabled:opacity-50"
                    ...
                    <button
                      ...
                      className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-rose-600 px-3 py-2.5 text-sm font-bold text-white hover:bg-rose-700"
                    >
                      ■ Stop
                    </button>
                  )}
      ...
      {isComplete &&
        currentIndex > 0 &&
        currentIndex >= (lessonExercises?.length || 1) && (
          <div className="fixed inset-0 z-[500] flex items-center justify-center bg-slate-900/90 backdrop-blur-xl p-4">
